...
\usepackage{amssymb,amsfonts,amsmath,amscd,bm}
...
\begin{figure}
  \begin{center}
    ...
    %\includegraphics[width=4in]{figs/example.png}
    %\includegraphics[height=4in]{figs/example.png}
    %\includegraphics[width=0.5\textwidth]{figs/example.png}
